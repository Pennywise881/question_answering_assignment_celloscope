...
'''
I have to change the data as some labels are empty and this creates an error in the DataLoader. 
Therefore I have to find and select only those rows from the dataset that have 2 labels 
i.e. a start position and an end position 
'''
